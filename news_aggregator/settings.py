...
SECRET_KEY = 'django-insecure-v3)ff#q!a!7dfugmp#84c@6b+kyxzpkq+atz#z7y*=++0yowqb'
...
INSTALLED_APPS = [
    ...
    'news',
    'channels',
    'daphne',  # Django Channels ASGI server# ✅ Add this line to enable Django Channels
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # ✅ Add this line to specify the location of your templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Redis as Channel Layer Backend# settings.py
CHANNEL_LAYERS = {
    'default': {
...
ASGI_APPLICATION = "news_aggregator.asgi.application"
