...
from news.views import home, add_article , logout_view, read_more , profile , delete_article , category_view , like_article , dislike_article , about_page, projects_view , notifications_page # ✅ Import the new views
